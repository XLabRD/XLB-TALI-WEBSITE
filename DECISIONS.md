...
| DEC-17 | Pricing figures? | DECIDED | All USD, IVA (16%) + MX shipping included, no separate tax line: Founders $155 · Limited $185 · Standard $198 · extra Puk $55 · Cloud Pro $39/yr or $99 lifetime (≤5 Talis) with 24/12/6 months included per edition. Founders card shows Stripe's live price (worker `/price`, currently $155); all other figures are deliberate hardcoded literals — derived/multiplier pricing removed | `workers/checkout/worker.js`, `src/components/Pricing.astro`, `src/components/ShipSchedule.astro`, `src/content/site/home.json`, `src/content/plans/founder.json`, FAQ entries | 2026-07-01: placeholder editions. 2026-07-02: pitch deck targeted 2,000 MXN + 2,400 MXN/yr — superseded. 2026-07-26–28: $148 test → $155; multiplier-derived table built then removed same day per author's pricing-update spec (2026-07-28). Still test-mode Stripe — live price object needed at launch |
